/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=app/wrangler.jsonc app/src/worker-configuration.d.ts` (hash: 8b9c490df9664752f4aab5f06f78b511)
// Runtime types generated with workerd@1.20260828.1 2026-08-29
interface __BaseEnv_Env {
	COMMUNITY_DB: D1Database;
	RPC_LIMITER: RateLimit;
	API_LIMITER: RateLimit;
	ASSETS: Fetcher;
	SOLANA_RPC_URL: string;
	BURN_SERVICE: Fetcher /* onchainburner-quote-service */;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SOLANA_RPC_URL">> {}
}
