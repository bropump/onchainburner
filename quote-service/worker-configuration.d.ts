/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=quote-service/wrangler.jsonc quote-service/worker-configuration.d.ts` (hash: 1bfb20f767244ddc2bb738495b0ab9f2)
...
interface __BaseEnv_Env {
	...
	BURNER_MAX_AMOUNT_LAMPORTS: string;
	BURNER_MAX_SLIPPAGE_BPS: string;
	BURNER_MAX_PRICE_IMPACT_BPS: string;
	IRYS_PRIVATE_KEY: string;
	CLOUDFLARE_IMAGE_WORKER_URL: string;
	CLOUDFLARE_IMAGE_WORKER_TOKEN: string;
	METADATA_UPLOAD_GATE: DurableObjectNamespace<import("./worker").MetadataUploadGateV3>;
	IMAGE_PIPELINE: Fetcher /* onchain-burner-image-pipeline */;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker");
		durableNamespaces: "MetadataUploadGateV3";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BURNER_RPC_URL" | "BURNER_ALLOWED_ORIGINS" | "BURNER_MAX_AMOUNT_LAMPORTS" | "BURNER_MAX_SLIPPAGE_BPS" | "BURNER_MAX_PRICE_IMPACT_BPS" | "IRYS_PRIVATE_KEY" | "CLOUDFLARE_IMAGE_WORKER_URL" | "CLOUDFLARE_IMAGE_WORKER_TOKEN">> {}
}
